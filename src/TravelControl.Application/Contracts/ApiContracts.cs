...
public sealed record PassengerListItem(Guid Id, string FullName, string MaskedPassport, PassportStatus PassportStatus,
    ...
    IReadOnlyList<PassengerFlightSummary> Flights, string? NextAction, DateOnly? NextActionDueDate,
...
public sealed record AirlineSummary(string Name, int Passengers);
