...
export function App(){return <Routes>
  ...
  <Route path="/gestion" element={<Protected/>}><Route index element={deferred(<DashboardPage/>)}/><Route path="pasajeros" element={deferred(<PassengersPage/>)}/><Route path="pasajeros/:id" element={deferred(<PassengerDetailPage/>)}/><Route path="habitaciones" element={deferred(<RoomsPage/>)}/><Route path="vuelos" element={deferred(<FlightsPage/>)}/><Route path="equipaje" element={<Navigate to="/gestion/vuelos?focus=baggage" replace/>}/><Route path="pendientes" element={deferred(<PendingPage/>)}/><Route path="importar" element={deferred(<ImportExportPage/>)}/><Route path="auditoria" element={deferred(<AuditPage/>)}/><Route path="usuarios" element={deferred(<UsersPage/>)}/></Route>
  <Route path="/passengers" element={<LegacyRedirect to="/gestion/pasajeros"/>}/><Route path="/passengers/:id" element={<LegacyPassengerRedirect/>}/><Route path="/rooms" element={<LegacyRedirect to="/gestion/habitaciones"/>}/><Route path="/flights" element={<LegacyRedirect to="/gestion/vuelos"/>}/><Route path="/baggage" element={<Navigate to="/gestion/vuelos?focus=baggage" replace/>}/><Route path="/pending" element={<LegacyRedirect to="/gestion/pendientes"/>}/><Route path="/import" element={<LegacyRedirect to="/gestion/importar"/>}/><Route path="/users" element={<LegacyRedirect to="/gestion/usuarios"/>}/><Route path="/audit" element={<LegacyRedirect to="/gestion/auditoria"/>}/>
